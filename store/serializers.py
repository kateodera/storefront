...
from store.models import Customer, Order, OrderItem, Product, Collection, ProductImages, Review, Cart, CartItem
...
class ProductImageSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        return ProductImages.objects.create(product_id = self.context['product_id'], **validated_data)
...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Customer
        fields = ['id', 'user_id', 'phone', 'birth_date', 'membership_model']
